        ...
        <div className="px-6 py-4 space-y-3">
          ...
          <div className="max-h-48 overflow-y-auto space-y-2">
            {duplicates.map((d) => (
              <div
                key={d.id}
                className="flex items-center gap-3 p-3 bg-[var(--bg-primary)] dark:bg-[var(--bg-elevated)] rounded-lg border border-[var(--border-subtle)] dark:border-[var(--border-subtle)]"
              >
